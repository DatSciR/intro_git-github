...
1.  Revisad vuestra cuenta de GitHub y comprobad los cambios que se han hecho en el proyecto compartido, tanto en la rama main como en la rama creada en el ejercicio 2.2, quién los ha hecho y las lineas que se han cambiado.
...
1.  Crea un script en tu repositorio y añade algunas lineas o utiliza uno ya creado
