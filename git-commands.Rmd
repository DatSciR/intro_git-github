...
-   **git push origin branchname**: to send files to another branch. In this case branchname is the name of the branch.
-   To set a branch as default: **git push --set-upstream origin branchname**. Then you do not need to specify the branch you are pushing the commits
...
-   **touch filename**: to create a new file in a repository. Then go to nano and add text (same as using nano directly)
...
-   **history**: shows the previous commands used
-   **clear**: refresh it
