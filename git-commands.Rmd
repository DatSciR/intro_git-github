...
-   git commit: save the changes to the local repository
    ...
    -   `git stash`: when you don't want to do a commit of half-done work so you can get back to this point later
    -   `git stash list`: see which stashes you've stored
    -   `git stash apply`: apply (recover) any stash you've stored in the stash list
