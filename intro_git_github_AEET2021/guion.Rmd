...
2.  Los invitados descargan los archivos del repositorio al que has sido invitado.
3.  Una persona modifica el archivo README.txt, registra tus cambios y actualiza el repositorio remoto al que ha sido invitado.
...
Cuando hago un cambio que no quiero ¿cómo lo puedo resolver? Tenemos tres opciones: *restore*, *reset* y *revert*. Restore se usa cuando no has llegado a hacer un commit con los cambios que quieres eliminar y reset/revert cuando si has hecho un commit con los cambios.
