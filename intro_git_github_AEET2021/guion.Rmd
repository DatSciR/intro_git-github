...
-   `git add filename.txt`: registra todos los cambios en el archivo llamado filename.txt para el siguiente commit.
...
-   `git revert HEAD ~1`: es la opción segura de git reset para deshacer un commit ya que no resetea un proyecto a su estado anterior eliminando todos los comitts posteriores.
