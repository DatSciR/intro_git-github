...
El propósito original de Git era ayudar a grupos de desarrolladores informáticos trabajar en colaboración en grandes proyectos de software pero en este taller veremos que también se puede utilizar para otros propósitos.
...
5.  En GitHub, busca el commit anterior, y comprueba dónde puedes ver qué cambios se han hecho y quién los ha hecho
...
-   `git rm --cached filename`: elimina un archivo del Index (dejaría de estar en el área de preparación). Muy útil para no commitir archivos de 10GB `r emo::ji("wink")`
