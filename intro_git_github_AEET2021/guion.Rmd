...
![final.doc](images/git-2.jpg) 
\- Ediciones sin control de cambios

![Ediciones sin control de cambios](https://dilbert.com/strip/2020-08-13)
...
![arboles](images/arboles.jpg)

Pasos para ir de un árbol a otro:

Al principio todos los cambios realizados están en amarillo porque Git no sabe que hacer con ellos. Estamos en la zona de trabajo y puede que no nos interese guardar todos los cambios para el futuro.
