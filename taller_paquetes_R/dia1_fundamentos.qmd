...
-   **Pull requests**: lo veremos más adelante para qué sirve.
...
En la pestaña *Code* del repositorio de GitHub podemos observar el contenido de nuestro proyecto:
...
⚡En los *issues* se puede referenciar a una línea concreta de código entrando en el archivo en la pestaña *Code* y clickando en el número de línea que se quiere comentar, o un *commit* entero copiando el SHA.
...
Cuando el trabajo desarrollado en una rama se da por finalizado y se quiere unir a la rama principal ("*main*") hay que hacer la unión. Esto se puede hacer con el botón "*pull request*" en la página del proyecto en GitHub.
...
<!--# Habría que comprobar si los conflictos salen así en Github o como va -->
...
<!--# Se puede abortar el merge con pull request? -->
