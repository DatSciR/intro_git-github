...
1.  **Un integrante** del equipo crea un repositorio en GitHub y lo conecta a un nuevo proyecto de RStudio (esto generará un repositorio (carpeta) en tu ordenador en la ubicación que hayas especificado). Incluir un archivo "*.gitignore".*
...
En el proyecto de cada equipo, guardad y subid a GitHub los cambios realizados en el Ejercicio 1.2 (`git add` + `git commit` + `git push`)
