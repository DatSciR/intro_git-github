...
2.  Combina la rama del ejercicio 2.2 con la rama principal del proyecto.
...
En GitHub también se puede acceder a la historia de commits de cada archivo en concreto (*History*) y al autor de cada parte del código (*Blame*). El historial de los archivos también es accesible a través de RStudio (🕒).
...
# Algunos puntos para evitar el caos en tu repositorio

<!---V: El git ignore se me queda colgado. Quizás podemos meterlo en este apartadoy ampliar un poco con otras cosas?-->
