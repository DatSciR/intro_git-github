...
<!---V: Al final he puesto primero git y luego github porque me cuadraba más. Si no te mola se puede dar la vuelta-->
...
2.  Los invitados clonan el repositorio al que han sido invitados a su repositorio local.
...
Esto se puede hacer en el *shell* como acabamos de ver pero también se puede hacer con el botón "*pull request*" en la página del proyecto en GitHub como veremos más adelante.
...
1.  Un integrante del equipo modifica también la primera frase del archivo README.txt en la rama main y sube los cambios al repositorio remoto. Esta frase había sido previamente modificada en una rama en el ejercicio 5.
2.  Combina la rama del ejercicio 5 con la rama principal del proyecto.
