...
<!---POR HACER- JA: a que te refieres en este punto? si es lo de como ver la historia de los commits, como referenciar en issues una linea de algun commit anterior, etc. creo que lo uniria con el punto de otras utilididades de github. en este sentido, explicaria primero toda la info relacionado con github y luego con git (el merge). es decir no andaria a saltos entre git y github como esta ahora-->

# Más detalles de los repositorios

<!---Incluir link para conectar repo antiguo https://happygitwithr.com/existing-github-first.html- JA: yo este punto lo pasaria al dia 1 justo antes del ejercicio 2-->
...
<!---Incluir link abort git merge --abort: https://happygitwithr.com/git-branches.html (comando util para añadir). JA: perfe--->
