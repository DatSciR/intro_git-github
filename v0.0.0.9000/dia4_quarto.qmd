...
<!--# quedan por añadir ejercicios -->

# [R Markdown](https://rmarkdown.rstudio.com)

<!--# Yo esto lo escribiria en párrafo, para que sea como el resto. No puedo aportar mucho hasta que no hablemos -->

-   `knitr` empezó en el 2011 y R Markdown en 2014. Desarrollado principalmente por [Yihui Xie](https://yihui.org/) <!--# Decir que es knitr? -->

-   Programación literaria. Es una paradigma de programación creado por Donald E. Knuth que consiste en escribir la lógica del programa en un lenguaje humano (p. ej. inglés/castellano) con fragmentos de código e instrucciones.
...
<!--# Creo que esto lo subiria a donde hablamos de los chunks y pondria estos ejemplos -->
...
La diferencia principal de Quarto respecto a R Markdown es que se ha generado para la colaboración de más de una comunidad (es decir, no solo usuarios de R o Phyton). La extensión de Quarto es `.qmd` y utiliza filtros Lua. Los filtros Lua permiten ir más allá del lenguaje R <!--# Explicaria un poco más que es esto -->. Utiliza una sintaxis y formato compartido entre distintos lenguajes.
...
📝**Ejercicio:** algunos grupos generaran un documento R Markdown y otros un documento Quarto que esté compuesto por al menos metadatos, código y texto, pero también se pueden añadir otros elementos, como tablas. El objetivo es comparar la estructura y sintaxis de ambos documentos.
...
📝**Ejercicio:** convertimos todos los archivos <!--# Que archivos, los del ejercicio anterior? --> a `.qmd` y los renderizaremos a HTLM y word mediante la opción de renderización que más os guste.
...
📝**Ejercicio:** generar una plantilla y modificar los colores, tamaño de los títulos, etc. Después, lo añadimos al YAML. <!--# Tengo que mirarlo bien, pero puede que esto de las referencias sea mejor otro ejercicio? -->Añadiremos alguna referencia en el documento y lo renderizaremos. Por último, subiremos este documento a nuestro repositorio de GitHub.
