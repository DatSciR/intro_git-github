...
📝**Ejercicio:** convertimos todos los archivos del ejercicio anterior a `.qmd` y los renderizaremos a HTLM y word mediante la opción de renderización que más os guste.
